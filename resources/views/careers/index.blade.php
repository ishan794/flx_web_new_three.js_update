...
{{-- Hero Section --}}
<section class="pt-32 pb-24 bg-[#05070F] relative overflow-hidden">
    {{-- Dot Grid Overlay --}}
...
<section id="openings" class="bg-[#F8F9FC] py-24">
    <div class="container max-w-5xl mx-auto px-6">
        ...
        <div class="mb-12 scroll-animate">
            ...
            <h2 class="text-[#111827] font-bold text-4xl mb-4">Open Positions</h2>

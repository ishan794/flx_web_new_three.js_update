...
@section('content')
<section class="py-32 section-light min-h-screen flex items-center justify-center text-center">
    <div class="container max-w-3xl mx-auto px-6 scroll-animate">
        ...
        <h1 class="text-3xl lg:text-4xl md:text-5xl font-bold text-text-primary mb-6">Flxware Blog</h1>

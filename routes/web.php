...
Route::get('/portfolio/{project}', function () {
    return view('portfolio'); // Just load the main portfolio view for now to prevent 404s
})->name('portfolio.show');

// Fallback named routes for the old Vanilla UI navbar
Route::get('/services', function() { return redirect('/#services'); })->name('services');
Route::get('/about', function() { return redirect('/#about'); })->name('about');
Route::get('/contact-page', function() { return redirect('/#contact'); })->name('contact');

Route::get('/careers-alias', function() { return redirect()->route('careers.index'); })->name('careers');

// Give the existing blog route a name
Route::get('/blog-page', function () {
    return view('blog');
})->name('blog');

// And portfolio base
Route::get('/portfolio-page', function() { return redirect('/#portfolio'); })->name('portfolio');
